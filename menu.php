<nav nav-reveal-menu style="background:#002;">
       <!-- line -->
       <!--<hr class="line">-->

       <!-- / End line-->
       <!--<ul class="main-ul animated slideInLeft">
         <li class="hvr-underline-from-left"><a href="#">The Creator and His Messengers</a>
         <ul>
           <li><a href="#">Who Created Us?</a>
           ...
           <li><a href="#">The Creatures of God</a>
            <ul class="animated fadeInUp">
           ...
           <li><a href="#">The Messengers of God</a>
            <ul class="animated fadeInUp">
           ...
           <li><a href="#">Who Brought the Final Message?</a>
            <ul class="animated fadeInUp">
         ...
         <li><a href="#">The Message and the Final Calls</a>
          <ul>
           ...
           <li><a href="#">Calls to the Human Being</a>
            <ul class="animated fadeInUp">
                ...
                <div class="nav-inner">
                    <ul>
                        <li class="_nav-item " id="main_page">
                            <a href="" style="color:#fff;"> <span class="menu__item-name" style="width: 127%;font-size: 19px;">The Creator and His Messengers</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay01" id="testimonials" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"> <span class="menu__item-name">- Who Created Us?</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay02 " id="HisCharacter" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"> <span class="menu__item-name">- The Creatures of God</span></a>

                        </li>

                        <li class="_nav-item animate showFromLeft delay03" id="biography" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- The Messengers of God</span></a>

                        </li>
                        <li class="_nav-item animate showFromLeft delay04" id="prophecy" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="javascript:void(0)" style="color:#fff !important;"><span class="menu__item-name" style="width:120%;">- Who Brought the Final Message?</span></a>

                        </li>
                        <li class="_nav-item delay05" id="civilization">
                            <a href="javascript:void(0)" style="color:#fff !important;"><span class="menu__item-name" style="width: 127%;font-size: 19px;">The Message and the Final Calls</span></a>

                        </li>
                        <li class="_nav-item animate showFromLeft delay06" id="women" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="javascript:void(0)" style="color:#fff !important;"><span class="menu__item-name">- What is it About</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay07" id="HumanRights" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- Calls to the Human Being</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay08" id="environment" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- Calls to all People</span></a>

                        </li>
                        <li class="_nav-item animate showFromLeft delay09" id="miracles" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="javascript:void(0)" style="color:#fff !important;"><span class="menu__item-name">- The Day of Judgment</span></a>

                        </li>
                        <li class="_nav-item" id="HisSayings" style="text-align:left;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name" style="width: 127%;font-size: 19px;">You !</span></a>

                        </li>
                        <li class="_nav-item animate showFromLeft delay011" id="epilogue" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- You and God</span></a>

                        </li>
                        <li class="_nav-item animate showFromLeft delay012" id="arts" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- Do You Talk To God ?</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay012" id="latest_news" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- Appendix</span></a>
                        ...
                        <li class="_nav-item animate showFromLeft delay012" id="audios_news" style="text-align: left !important;margin-left: 30px !important;">
                            <a href="" style="color:#fff !important;"><span class="menu__item-name">- References</span></a>
                    ...
                    <div class="inside">
                        <div class="inner-menu testimonials" style="display: none;">
                            ...
                            <ul class="animated fadeInUp innerUL">
                              <li ><a href="c1-sub1-logic.php" class="hvr-to-righ">Logical Questions</a></li>
                              <li><a href="c1-sub2-our.php" class="hvr-to-righ">Our Lord And Our God</a></li>
                              <li><a href="c1-sub3-end.php" class="hvr-to-righ">End Notes</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu HisCharacter " style="display: none;">
                            <h2>The Creatures of God</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c2-sub1-Invisible.php" class="hvr-to-righ">The Invisible Creatures Of God</a></li>
                              <li><a href="c2-sub2-visible.php" class="hvr-to-righ">The Visible Creatures Of God</a></li>
                              <li><a href="c2-sub3-strange.php" class="hvr-to-righ">Some Strange Creatures Of God</a></li>
                              <li><a href="c2-sub4-end.php" class="hvr-to-righ">End Notes</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu biography" style="display: none;">
                            <h2>The Messengers of God</h2>
                           <ul class="animated fadeInUp innerUL">
                              <li><a href="c3-sub1-story.php" class="hvr-to-righ">The Story Of Life And Divine Revelations</a></li>
                              <li><a href="c3-sub2-quran.php" class="hvr-to-righ">The Messengers Of God In Quran</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu prophecy" style="display: none;">
                            <h2>Who Brought the Final Message?</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c4-s1-mohamed.php" class="hvr-to-righ">Prophet Muhammed</a></li>
                              <li><a href="c4-s2.php" class="hvr-to-righ"> Brief Biography</a></li>
                              <li><a href="c4-s3.php" class="hvr-to-righ">Muhammed And The Unbelievers</a></li>
                              <li><a href="c4-s4.php" class="hvr-to-righ">Muhammed'S Farewell Sermon</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu women" style="display: none;">
                            <h2>What is it About</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c5-s1.php" class="hvr-to-righ">The History Of The Bible</a></li>
                              <li><a href="c5-s2.php" class="hvr-to-righ">The History Of The Quran</a></li>
                              <li><a href="c5-s3.php" class="hvr-to-righ">The DIVINE MESSAGE</a></li>
                              <li><a href="c5-s4.php" class="hvr-to-righ">Verses From The Quran About The Quran</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu HumanRights" style="display: none;">
                            <h2>Calls to the Human Being</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c6-se1.php" class="hvr-to-righ">He Divine Calls To Mankind</a></li>
                              <li><a href="c6-se2.php" class="hvr-to-righ">The MIRACULOUS Creation</a></li>
                              <li><a href="c6-se3.php" class="hvr-to-righ">The Comopnents of The Human Body</a></li>
                              <li><a href="c6-se4.php" class="hvr-to-righ">The Noble Quran</a></li>
                              <li><a href="c6-se5-end.php" class="hvr-to-righ">End Notes</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu environment" style="display: none;">
                            <h2>Calls to all People</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c7-sec1.php" class="hvr-to-righ">Divine Calls To All People</a></li>
                              <li><a href="c7-sec2.php" class="hvr-to-righ">A Chapter From The Quran</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu miracles" style="display: none;">
                            <h2>The The Day of Judgment</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c8-sec1.php" class="hvr-to-righ">Death And Resurrection</a></li>
                              <li><a href="c8-sec2.php" class="hvr-to-righ">The Day Of Judgment in The Quran</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu epilogue" style="display: none;">
                            <h2>You and God</h2>
                            <ul class="animated fadeInUp innerUL">
                            <li><a href="c9-sec1.php" class="hvr-to-righ">The Cognitive Content</a></li>
                            <li><a href="c9-sec2.php" class="hvr-to-righ">Self-Pride Versus</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu arts" style="display: none;">
                            <h2>Do You Talk To God ?</h2>
                            <ul class="animated fadeInUp innerUL">
                              <li><a href="c10-sec1.php" class="hvr-to-righ">The Jewels of Reflection</a></li>
                              <li><a href="c10-sec2.php" class="hvr-to-righ">Supplication is Worship</a></li>
                            </ul>
                        </div>
                        <div class="inner-menu latest_news" style="display: none;">
                            <h2>Appendix</h2>
                            <a href="appendix.php" class="hvr-to-righ">Appendix</a>
                        </div>
                        <div class="inner-menu audios_news" style="display: none;">
                            <h2>References</h2>
                            <a href="references.php" class="hvr-to-righ">References</a>
                        </div>
                    </div>
                </div>
            </div>
