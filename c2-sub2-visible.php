...
<?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center">The Visible Creatures of God</h1>
            </div>
             <div class="col-sm-2">
                <?php
                     include 'menu.php';
...
<section class="content padding-y-50px ">
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/23.jpg'); background-size: cover;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            ...
            <p data-aos="fade-left"  data-aos-duration="400">Zoologists have identified and recorded 31,153 species of
                    ...
                    about 900,000 species of insects. <br>
                However, scientists estimate that there could be hundreds
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/22.jpg'); height: 460px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
          <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">The interdependence of creatures</h2>
