...
<?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center"> Some Strange Creatures of God</h1>
            </div>
             <div class="col-sm-2">
                  <?php
                     include 'menu.php';
...
<section class="content padding-y-50px ">
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/25.jpg'); background-size: cover; height: 350px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Bombardier Beetle</h2>
                <p data-aos="fade-left" data-aos-duration="300" >
                        ...
                        belly up to 70 times in less than a fraction of a second. <br>
                ...
                <p data-aos="fade-left"  data-aos-duration="600" class="small"><img src="img/sub/hyd.png" alt=""><br> In Judaism, the name of God is a word of four letters,
   ...
   <div class="row  section-text-img">
    ...
    <div class="col-md-8 conent-text text-left">
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                The liquid can be fatal to small insects or creatures and very
                        painful to humans. You can watch this incredible insect on
                        the following link. <br>
                Evolution theories cannot explain the extraordinary
                ...
                <p data-aos="fade-right" data-aos-duration="300" class="aos-init">
                         ...
                         <br>
                         <a href="https://www.youtube.com/watch?v=lKM9yoQ3Wug#t=22">https://www.youtube.com/watch?v=lKM9yoQ3Wug#t=22,also in explorationfilms.com.
                         </a>
                </p>
                 <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Praying Mantis</h2>
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/28.jpg'); background-size: cover;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            ...
            <p  data-aos="fade-left" data-aos-duration="800" >
                   <span class="q">Source</span>
                   <br>
                   <a href="https://www.nationalgeographic.com/animals/invertebrates/p/praying-mantis/">https://www.nationalgeographic.com/animals/invertebrates/p/praying-mantis/</a>  
            </p>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/29a.png'); height: 465px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
          <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init"> Mantis Shrimp</h2>
...
<!-- row end right text d-->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/30.jpg'); background-size: cover; height: 325px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                <p data-aos="fade-left"  data-aos-duration="300"> 
                ...
                <p data-aos="fade-left"  data-aos-duration="200">
                        <span class="q">Source</span>
                        <br>
                        <a href="https://www.youtube.com/watch?v=F5FEj9U-CJM">https://www.youtube.com/watch?v=F5FEj9U-CJM</a>
                </p>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/31.jpg'); background-position: center bottom;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/30a.png'); height: 470px !important; background-size: cover; background-position: top;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                 <h2 data-aos="fade-left" data-aos-duration="700" class="aos-init">The Housefly</h2>
                <p data-aos="fade-left"  data-aos-duration="300">Out of the 900,000 types of insects, there are more than
                        ...
                        them all. <br>
                Let us look at the housefly anatomy. The body of a fly (like
                        other insects) has three parts: thorax, abdomen and head. It
                        has a hard exoskeleton that protects it from moisture loss.
                </p>
                <p data-aos="fade-left"  data-aos-duration="400">The fly's thorax features all of its limbs used for movement.
                        ...
                        main wings. <br>
                However, houseflies have tiny, secondary wings, called
                        halters, located below the main pair of wings. 
                </p>
                <p data-aos="fade-left"  data-aos-duration="500">The halters are mainly used to achieve balance. They can
                        fly up and down, side to side and even backwards. <br>
                        The common housefly can travel with a flying speed of
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url(img/sub/32.jpg); background-size: cover; background-repeat: no-repeat; background-position: center right;; background-repeat: no-repeat;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
         ...
         <p data-aos="fade-right" data-aos-duration="400" class="aos-init  padding-y-0px">
                ...
                smell.
                <br>
                 The head of the fly contains the eyes, antennae and
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/31.png'); background-size: cover; height: 400px !important; background-position: right;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                <p  data-aos="fade-left"  data-aos-duration="900">The common fly has no mouth, but instead an eating tube.
                        ...
                        part of its meal to liquefy it .  <br>
                This fluid is then sucked up along with the nutrients it has
                    dissolved, leaving behind untold numbers of germs. <br>
                    The fly has two compound eyes, which are the most
                    complex in the insect world, allowing them to see a
                    significant radius around their body. 
                </p>
            <p data-aos="fade-left"  data-aos-duration="200">Each eye has 4,000 separate lenses, which provide wide
                    angle vision that is in fact omni-directional. This makes
                    flies difficult to surprise or swat. <br>
                The latest state-of-the-art technology cannot create a robotfly
                    weighing one gram. It cannot create a robot that can
                    reproduce or spawn similar robots without raw material. <br>
                    Also, it is impossible to copy the flying mechanism in such
                    a small size. It would require a power supply and wings
                    with many hinges and small bolts. <br>
                    The creation of the fly is really
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/32a.png')"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
          <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">   How difficult is to make a robot similar to a fly? </h2>
        ...
        <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
                ...
                <br>
                <span class="qura">Quran, 22:73</span>
        </p>
