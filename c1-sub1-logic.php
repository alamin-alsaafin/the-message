    ...
    <?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center">LOGICAL QUESTIONS</h1>
...
<section class="content padding-y-50px ">
    <div class="container">
            <div class="row">
                    <div class="col-sm-12">
                           <p class="q text-center">The one who created us and gave us life must be the
            ...
            <div class="content-sec2 padding-y-50px">
                ...
                <!-- start row -->
                    <div class="row  section-text-img">
                        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/9.jpg'); background-size: cover;     height: 380px !important;"></div>
                        </div>
                        <div class="col-md-8 conent-text text-left order-md-first">
                             
                            <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">What is the link between the sun and life on earth?</h2>
                            <p  class="q wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.5s" ></p>
                    ...
                    <div class="row  section-text-img">
                        ...
                        <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Another important fact about photosynthesis:</h2>
                ...
                <div class="row section-text-img">
                    <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                            <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/11e.png'); height: 515px !important; background-size: contain; "></div>
                    </div>
                    <div class="col-md-8 conent-text text-left order-md-first">
                                <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">What will happen if the earth gets closer or farther from
                                    the sun (i.e. gests out of its orbit)? 
                               </h2>
                        <p   data-aos="fade-right" data-aos-duration="600">The Earth is surrounded
                                ...
                                radiation, solar winds and harmful cosmic rays. <br>

                                Science indicates that life would disappear from the Earth if
                                it gets closer or farther from a certain distance to the sun. We
                                will either be burned or frozen. 
                        </p>
                        <p data-aos="fade-right" data-aos-duration="700" class="aos-init padding-y-0px">
                                        We are part of a solar system that comprises eight large
                                ...
                                <br> Plants on the Earth need sunlight for a fundamental process
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/12.jpg'); background-size: cover; height: 420px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/13.jpg'); background-size: cover;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Are there any other creators?</h2>
            <p data-aos="fade-left"  data-aos-duration="700">   The precise and interdependent system that controls the
                universe indicates it must be created by one and only one
                creator. Otherwise, multiple creators would have different
                ways of creation and different controlling systems. </p>
