...
<section class="content padding-y-50px ">
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/18.jpg'); height: 405px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            <p data-aos="fade-left"  data-aos-duration="200"> <img src="img/sub/11.jpg" alt="" class="imgearth"> The brightest star in our sky is called Sirius A, which is relatively close
                    to our planet (8.6 light years). If Sirius A was placed next to our sun,
                    Sirius A would outshine it more than 20 times over <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> A light year abbreviated "ly" is a unit of length used to express
                    astronomical distances. It is approximately 9 million million (trillion)
                    kilometers. <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> The speed of light is approximately 300,000 km/second. 
                </p>
            <p data-aos="fade-left"  data-aos-duration="300"><img src="img/sub/11.jpg" alt="" class="imgearth"> The moon is only 384,400 kilometers away from the Earth. <br>
                <img src="img/sub/11.jpg" alt="" class="imgearth"> The longest distance between two points on the Earth is estimated to
                    be 20,036 kilometers. <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> The sun's light takes about 8 minutes to reach the earth after it has
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/20.jpg'); background-size: cover;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                ...
                fields. However, <span class="qura">Quran 51:7</span>  precisely describes the sky that it
                ...
                video
                <br><a href="https://www.youtube.com/watch?v=j9XmJdAcGwM">https://www.youtube.com/watch?v=j9XmJdAcGwM</a>
        </p>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/21.jpg'); background-size: cover;  height: 420px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                 <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">The Big Bang and The Expanding Universe</h2>
