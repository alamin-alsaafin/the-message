...
<?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center"> Our Lord and our God</h1>
            </div>
            <div class="col-sm-2">
                 <?php
                     include 'menu.php';
...
<section class="content padding-y-50px ">
    <div class="container">
        <div class="row">
                <div class="col-sm-12">
                        <p class="q text-center">Our creator is the Lord of all beings because He created
        ...
        <div class="row  section-text-img">
                <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                        <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/11aa.jpg'); background-size: cover;"></div>
                </div>
                <div class="col-md-8 conent-text text-left order-md-first">
                        <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">What is the name of our God? </h2>
                        <p data-aos="fade-left"  data-aos-duration="600">In Judaism, the name of God is a word of four letters,
                                ...
                                which means God. <br>
                                Many Jews also write "G-d" instead of "God". They do it to
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/14.jpg'); background-size: cover; height: 535px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <div class="Self-Pride">
                ...
                <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                        ...
                        equivalent.
                        <span class="qura">Quran, 112:1-4</span> 
                </p>
        </div>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/22aa.jpg'); background-size: cover; height: 370px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            <p  data-aos="fade-left" data-aos-duration="300" >
                    Allah, there is no deity except Him, the EverLiving,
                    the Sustainer of all existence. <br>
                    Neither drowsiness overtakes Him nor
                    sleep. To Him belongs whatever is in the
                    heavens and whatever is on the earth.
            </p>
            <p data-aos="fade-left"  data-aos-duration="400">Who is it that can intercede with Him
                    except by His permission? He knows
                    what lies before [His creatures] and
                    what lies behind them. <br>
                They encompass not a thing of His
                    knowledge except for what He wills. 
                </p>
            <p data-aos="fade-left"  data-aos-duration="500">His Throne (seat of divinity) extends over the heavens
                    and the earth. Preserving and guarding them does not
                    fatigue Him. <br>
                He is the Most High, the Most Great.<br>
               <span class="qura">Quran, 2:255</span>
                </p>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/15.jpg'); background-size: cover; height: 440px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
                ...
                <br>
                <span class="qura">Quran, 6:1-3</span>
        </p>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/15aa.jpg'); background-size: cover; height: 350px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            ...
            <p  data-aos="fade-left" data-aos-duration="300" > And it is He who made
                    ...
                    knowledge.
                    <br>
                    <span class="qura">Quran, 6:95-97</span></p>
            </p>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/17a.jpg'); background-size: cover;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
                ...
                <br>
                <span class="qura">Quran, 6:98-99</span>
        </p>
            <p data-aos="fade-right" data-aos-duration="700" class="aos-init  padding-y-0px">
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url(img/sub/16.jpg); height: 540px !important; background-position: center top;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                ...
                <p data-aos="fade-left"  data-aos-duration="300">That is Allah , your Lord;
                        there is no deity except
                        Him, the Creator of all
                        things, so worship Him.
                        He is the Disposer of all
                        things. <br>
                No eye can reach Him,
                        yet He attains all that eyes
                        can see. He is above all
                        comprehension. He is the
                        Subtle, the All-Aware.  <br>
                    <span class="qura">Quran, 6:95-103</span>
                </p>
               <h2 data-aos="fade-left" data-aos-duration="700" class="aos-init">What is the difference between Lord and God?</h2>
               <p data-aos="fade-left"  data-aos-duration="300">
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/18a.jpg'); background-size: cover; height: 430px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <div class="Self-Pride">
                ...
                <br>
                <span class="qura">Quran, 1:2</span>
                <br>
               
                Say I seek refuge in the Lord of people, the King of
                people, the God of people.
                <br>
                <span class="qura">Quran, 114:1-3</span> 
        </div>
        
        </p>
        <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">God's names and attributes:</h2>
        <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/15a.jpeg'); background-size: cover; height: 590px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                 <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Some of God's attributes in the Bible</h2>
               
            <p data-aos="fade-left"  data-aos-duration="200">This is the message we have heard from him and
                    declare to you: God is light; in him there is no darkness at <br>all. (1 John 1:5)<br>
            ...
            <p data-aos="fade-left"  data-aos-duration="300">Surely God is my help; the Lord is the one who sustains me. <br><span class="small">(Psalms 54:4)</span> <br>
                • Every word of God is flawless; he is a shield to those who
                take refuge in him.<span class="small">. (Proverbs 30:5) </span> <br>
                • For the Lord is righteous, He loves righteousness; His
                    countenance beholds the upright. <span class="small">(Psalm 11:7)</span>  <br>
                    • But as He who called you is holy, you also be holy in all
                your conduct, because it is written, "Be holy, for I am holy. <span class="small">(1 Peter 1:15-16)</span> <br>
                • He loves righteousness and justice; the earth is full of the
                    goodness of the Lord. <span class="small"> (Psalm 33:5)</span><br>
                ...
                clothing. <span class="small">(Deuteronomy 10:17-18)</span>
        </p>
        </div>
    </div>
    <!-- row end  left text-->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/16a.jpg'); background-size: cover; height: 460px !important;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
          <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init"> Some of God's attributes in the Quran</h2>
        ...
        <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
                ...
                <br>
                <span class="qura">Quran, 59:22-24</span>
                <br>
                Haven’t the disbelievers known
                    ...
                    not then believe? 
                    <br>
                    <span class="qura">Quran, 21:30</span>
        </p>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/17.jpg'); background-size: cover; height: 385px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            <p data-aos="fade-left"  data-aos-duration="200">He, the Almighty God, turned to the
                ...
                <br>
                <span class="qura">Quran, 41:11</span>
                   </p>
            <p data-aos="fade-left"  data-aos-duration="300"> And it is He who created the night and the
                day, and the sun and the moon. All (the
                celestial bodies) swim along (float), each in its
                rounded course (orbit). <br>
                <span class="qura">Quran, 21:33</span>
                <br>
                   With power and skill We created the heaven
                and We are continuously expanding it. <br>
                <span class="qura">Quran, 51:47</span>
                <br>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/18.jpg'); background-size: cover;"></div>
        </div>
    <div class="col-md-8 conent-text text-left">
