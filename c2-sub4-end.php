...
<?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center"> END NOTES</h1>
            </div>
             <div class="col-sm-2">
                 <?php
                     include 'menu.php';
...
<section class="content padding-y-50px ">
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/33a.jpg'); background-size: cover; height: 460px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
            ...
            <p data-aos="fade-left"  data-aos-duration="200"> <img src="img/sub/11.jpg" alt="" class="imgearth"> The human hearing range describes the range of frequencies that
                    ...
                    (in water). <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> Salmon sense the Earth’s magnetic field to guide them home <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> Bees can sense the electric field of a flower and use it to find pollen. <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> Mantis shrimp swing their arm out at 80 kph when they punch,
                    wich is about the same acceleration as a .22 caliber bullet
                </p>
            <p data-aos="fade-left"  data-aos-duration="300"> <img src="img/sub/11.jpg" alt="" class="imgearth"> lephants can lift almost 300 kilograms with their trunk. <br>
                <img src="img/sub/11.jpg" alt="" class="imgearth"> Dung beetles can pull over 1,000 times their body weight. This is
                    similar to an 80 kg man pulling 80,000 kg. <br>
                    <img src="img/sub/11.jpg" alt="" class="imgearth"> Dragon millipedes can shoot cyanide at their predators
        </p>
        </div>
    </div>
    <!-- row end  left text-->
   ...
   <div class="row  section-text-img">
    ...
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                        <img src="img/sub/11.jpg" alt="" class="imgearth"> Geckos and lizards can re-grow lost tails. Geckos can walk up walls
and windows due to electrostatic forces between thousands of
tiny hairs on their feet and the surface.
        </p>
        <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                        <img src="img/sub/11.jpg" alt="" class="imgearth"> Swifts (family of highly aerial birds) have been known to fly
                nonstop for nearly 200 days.
                
            </p>
             <p data-aos="fade-right" data-aos-duration="400" class="aos-init  padding-y-0px">
                        <img src="img/sub/11.jpg" alt="" class="imgearth">  Electric eels can generate electric shocks up to 600 volts.
            </p>
            <p data-aos="fade-right" data-aos-duration="500" class="aos-init  padding-y-0px">
                        <img src="img/sub/11.jpg" alt="" class="imgearth">  The horned lizard can shoot blood from its eye
            </p>
            <p data-aos="fade-right" data-aos-duration="600" class="aos-init  padding-y-0px">
                        <img src="img/sub/11.jpg" alt="" class="imgearth">  Some insects, such as gerridae (water striders), are able to walk
                    on the surface of water.
            </p>
                <p data-aos="fade-right" data-aos-duration="700" class="aos-init  padding-y-0px">
                                <img src="img/sub/11.jpg" alt="" class="imgearth">    Butterflies taste food by standing on top of it! Their taste receptors
                        are in their feet.                        
            </p>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/36.jpg'); background-size: cover; height: 490px !important;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
                ...
                <p  data-aos="fade-left"  data-aos-duration="200">There are more than 3,000 species of mosquitoes. It is
                        ...
                        up to 200 eggs. <br>
                Mosquitoes have antennae that detect the carbon dioxide
                    released when people or animals exhale. They also use heat
                    sensors to detect the warmth of the body. Mosquitoes prefer
                    O-type blood and victims with high body heat.
                </p>
                    <p data-aos="fade-right" data-aos-duration="500" class="aos-init  padding-y-0px">
                            The female mosquito has six mouthparts besides the labium,
                    ...
                    toothed blades used to cut the skin. 
                            <br>
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/34.png'); "></div>
        </div>
    <div class="col-md-8 conent-text text-left">
        ...
        <p data-aos="fade-right" data-aos-duration="500" class="aos-init  padding-y-0px">
                ...
                disobedient.
                <br>
                <span class="qura">Quran, 2:26 </span>
        </p>
...
<!-- row end right text -->
   ...
   <div class="row  section-text-img">
        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/34.jpg'); background-size: cover; background-position: top;"></div>
        </div>
        <div class="col-md-8 conent-text text-left order-md-first">
