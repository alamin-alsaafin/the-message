...
<?php
        ...
        <div class="row ">
           ...
           <div class="offset-sm-2">
            ...
            <div class="col-sm-8 ">
                <h1 class="text-center">THE INVISIBLE CREATURES OF GOD</h1>
            </div>
             <div class="col-sm-2">
                <?php
                     include 'menu.php';
...
<section class="content padding-y-50px ">
    <div class="container">
             <div class="row">
                    <div class="col-sm-12 text-center conent-text">
                           <p class="q text-center">
                                ...
                                <br>
                                 And He creates that which you do not know. <br>
                                 <span class="qura">Quran, 16:8</span>
                           </p>
            ...
            <div class="content-sec2 padding-y-50px">
                ...
                <!-- start row -->
                    <div class="row  section-text-img">
                        <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/22.jpg'); background-size: cover; height: 425px !important;"></div>
                        </div>
                        <div class="col-md-8 conent-text text-left order-md-first">
                                <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">God created angels from light</h2>
                                <p data-aos="fade-right" data-aos-duration="300" class="aos-init  padding-y-0px">
                                        Angels are invisible creatures or celestial beings that do
                                        God's will and carry out God's tasks such as managing
                                        certain functions in the universe. <br>
                                        Angels are God's soldiers. They worship Him and they are
                                        dedicated for Him (see Psalm 103:20, Matthew 26:53). <br>
                                        Angels are mentioned in the Bible from the Book of Genesis
                                        to the Book of Revelation. 
                                    </p>
                                     <p data-aos="fade-right" data-aos-duration="400" class="aos-init  padding-y-0px">
                                        Psalm 91:11, Matthew 18:10 and Acts 12:15 indicate
                                        humans have guardian angels. Matthew 13:49 indicates
                                        that angels will separate the wicked from the just on the
                                        Last Day. <br>
                                        In the Torah, the term "malak Elohim" refers to angels
                    ...
                    <div class="row  section-text-img">
                            <div class="col-md-4 conent-img-left"  data-aos="fade-up" data-aos-duration="1700">
                                    <div class="img-left-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/34.jpg'); height: 440px !important;"></div>
                            </div>
                        <div class="col-md-8 conent-text text-left">
                                
                            <p data-aos="fade-right" data-aos-duration="900" class="aos-init  padding-y-0px">
                                    Muslims believe that Archangel Gabriel revealed the final
                                ...
                                in the shape of a man. <br>
                                 Other angels recognized in Islam are Azrael, the angel of
                                death, Michael, the angel in charge of nature, and Israfel,
                                the angel who will blow the trumpet to announce the Day
                                of Resurrection.
                            </p>
                            <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">God created genies from a smokeless flame of fire:</h2>
                ...
                <div class="row section-text-img">
                    <div class="col-md-4 conent-img-right"  data-aos="fade-up" data-aos-duration="1700">
                            <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/sub/115.jpg'); background-size: cover; height: 440px !important;"></div>
                    </div>
                    <div class="col-md-8 conent-text text-left order-md-first">
                        <h2 data-aos="fade-right" data-aos-duration="700" class="aos-init">Other invisible creatures of God:</h2>
