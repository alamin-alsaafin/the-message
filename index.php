                    ...
                    <div class="content-sec2">
                        <div class="row">
                            ...
                            <div class="col-md-6 conent-img-right "  data-aos="fade-up" data-aos-duration="1700">
                                    <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200" style="background-image: url('img/img1.jpg'); background-size: cover;"></div>
                            </div>
        ...
        <div class="container">
                ...
                <div class="content-sec2">
                    <div class="row">
                        ...
                        <div class="col-md-6 conent-img-right" data-aos="fade-up" data-aos-duration="1700">
                                <div class="img-right-sec2" data-aos="flip-right" data-aos-duration="1200"  style="background-image: url('img/img4.jpg'); background-size: cover;"></div>
                        </div>
                        <div class="col-md-6 conent-text text-left order-md-first">
...
<section class="section-end">
    <div class="full-width">
        <div class="row">
            ...
            <div class="col-md-3 back-blue">
                    <div class="content-section-end">
                        <h2 class="title-end" data-aos="fade-left" data-aos-duration="700">Do You Talk To God ?</h2>
